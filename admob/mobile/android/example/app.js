 ...
 * After sending an email, we will display an interstitial ad (although it was created before).
 */
var emailDialog = Ti.UI.createEmailDialog( );
emailDialog.subject = "Testing Interstitial";
emailDialog.open( );

var interstitial = Admob.createInterstitialAd( {
  adUnitId: "<<YOUR AD UNIT ID HERE>>"
} );
win.add( interstitial );
emailDialog.addEventListener( 'complete', function( ) {
  // We call displayInterstitial after creating the view, and adding it to the window.
